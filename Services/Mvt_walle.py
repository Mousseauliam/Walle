...
class Walle:
    ...
    def neckLevel(self, necklevel):
        ...
        if necklevel<0.5:
            ...
            self.coef["neck_U"]=self.coef["neck_U"]-ratio
        elif necklevel>0.5:
            self.coef["neck_L"]=self.coef["neck_L"]+ratio
            self.coef["neck_U"]=self.coef["neck_U"]+ratio
        elif necklevel==0.5:
            self.coef["neck_L"]=self.coef["neck_L"]/2
            self.coef["neck_U"]=self.coef["neck_L"]/2
        elif necklevel==0.5:
            self.coef["neck_L"]=self.coef["neck_L"]/2
            self.coef["neck_L"]=self.coef["neck_L"]/2
        ...
        elif self.coef["neck_U"]>1:
            a=self.coef["neck_U"]-1
            self.coef["neck_U"]=1
            self.coef["neck_L"]-=a
    ...
    def turn (self, angle=0.5):
        ...
        self.coef[side]=(speed -0.3) if speed>0.5 else (speed +0.3)
